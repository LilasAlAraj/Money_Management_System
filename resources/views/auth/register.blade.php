                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3 ">
                                <label for="phone_number"
                                       class="col-md-4 col-form-label text-md-end">{{ __('Number phone') }}</label>
                                <div class="col-md-6 ">
                                    {{--    <select class="form-select" name="countryCode" id="countryCode"--}}
                                    {{--                                            title="country code" style="max-width: 7em; ">--}}
                                    {{--                                        <option>code</option>--}}
                                    ...
                                    {{--                                            </option>--}}
                                    {{--                                            <option data-countryCode="KY" value="1345">(+1345) Cayman Islands--}}
                                    {{--                                            </option>--}}
                                    ...
                                    {{--                                            <option data-countryCode="TC" value="1649"> (+1649) Turks &amp; Caicos--}}
                                    {{--                                                Islands--}}
                                    ...
                                    {{--                                            <option data-countryCode="VG" value="84"> (+1284) Virgin Islands ---}}
                                    {{--                                                British--}}
                                    {{--                                            </option>--}}
                                    {{--                                            <option data-countryCode="VI" value="84">(+1340) Virgin Islands - US--}}
                                    {{--                                            </option>--}}
